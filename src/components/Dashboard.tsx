...
export default function Dashboard() {
  ...
  // Estado da tela de abertura
  const [showSplash, setShowSplash] = useState(true);

  // --- ATENÇÃO: NÃO TEM MAIS useEffect COM TIMER AQUI ---
  // A tela fica parada até você clicar em "Acessar Sistema"

  // 1. SE TIVER QUE MOSTRAR O SPLASH, MOSTRA ELE
  if (showSplash) {
    return <SplashScreen onFinish={() => setShowSplash(false)} />;
  }

  // 2. ROTEAMENTO DAS FERRAMENTAS
